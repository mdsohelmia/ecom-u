...
@section('main')
    <div class="max-w-screen-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 2xl:gap-8">
            ...
            <div class="col-span-1 bg-white rounded-lg px-4 lg:px-8 py-4 lg:py-6">
                ...
                <div class="flex space-x-4 items-end mb-4 lg:mb-6">
                    ...
                    <span class="text-2xl mb-2 text-blue-900">€21.291,09</span>
                    <span class="text-blue-900 opacity-70 mb-2 whitespace-pre hidden xl:inline-block">/ €40.000</span>
                </div>
        ...
        <!-- quick actions -->
        <div class=" bg-white rounded-lg px-4 lg:px-8 py-4 lg:py-6 mt-8 flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-12">
            <div>
            ...
            <nav class="md:flex md:space-x-4 space-y-2 md:space-y-0">
                <a href="#" class="inline-flex flex-col justify-center items-center px-3 py-3 border border-blue-100 rounded-lg hover:bg-blue-50 w-32">
        ...
        <div class="bg-white rounded-lg px-4 lg:px-8 py-4 lg:py-6 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12">
                <div class="space-y-4 md:max-w-sm">
                    <a href="" class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                        ...
                        <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">€438</span>
                    </a>
                    <a href="" class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                        ...
                        <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">€256</span>
                    </a>
                    <a href="" class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                        ...
                        <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">€149</span>
                    </a>
                </div>
                <div class="space-y-4 md:max-w-sm">
                    <a href="" class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                        ...
                        <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">€136</span>
                    </a>
                    <a href="" class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                        ...
                        <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">€128</span>
                    </a>
                    <a href="" class="w-full flex items-center space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60">
                        ...
                        <span class="text-green-500 text-base mb-2 bg-green-100 border-full  px-3 rounded-full">€97</span>
                    </a>
                </div>
            </div>
