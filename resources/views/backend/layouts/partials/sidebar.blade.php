    ...
    <div class="flex-1 py-4">
        ...
        <nav class="md:mt-8 -mx-2">
            <ul class="text-base pt-2 space-y-3">
                <li>
                    <a href="{{route('dashboard')}}" class="bg-blue-50 hover:bg-blue-50 transition-colors duration-100 text-blue-800 flex items-end py-3 px-4 space-x-2 rounded-lg font-bold">
                ...
                <li>
                    <a href="{{route('users.create')}}" class="bg-white hover:bg-blue-50 transition-colors duration-100 text-blue-800 flex items-end py-3 px-4 space-x-2 rounded-lg font-bold text-opacity-70 hover:text-opacity-100">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
